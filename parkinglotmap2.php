...
<body>
  ...
  <div class="list">
    ...
    <button  id="timing" class="content" style="left:61%;top: 28%;">
     <a style="color: white; text-decoration: none;" href="timer.php">
      <div ><i class="fa-solid fa-clock"></i></div>幫我計時
      </a> 
    </button>
    <button id="eat" class="content" style="left:75%;top: 51.5%;">
    <a style="color: white; text-decoration: none;" href="./afmap.php">
  ...
  <ul style="position:fixed-top" >
    ...
    <li class="search" style="float:right;"><i href="#search" class="fa-solid fa-magnifying-glass"
        style="color: white; padding: 14px 16px; position: relative; top:2px;" onclick="toggleSearch()"></i></li>
  ...
  <div class="side-menu">
    <nav>
      <ul class="txt" style="height:120px">
        ...
        <li style="position:relative; left:-51.5px;">
          <input checked onclick="car()" type="radio" id="Car" name="category"><label for="Car"></label>
          <i class="fa-sharp fa-solid fa-car"></i>
          汽車
        </li><br>

        <li>
          <input onclick="motor()" type="radio" id="Scooter" name="category"><label for="Scooter"></label>
  ...
  <div class="navbar">
    <a style="color:  aqua; position: relative; top: -0.3px;left:3px" href="parkinglotmap.php" class="active">
  ...
  <!-- <button id="butt"; style="display:none; position:absolute; z-index: 9999;">123</button> -->
  <script>
  ...
  <script>
    ...
    setMapView(24.15143190611227, 120.66420189575864, 17); //設定地圖視野為,縮放程度
